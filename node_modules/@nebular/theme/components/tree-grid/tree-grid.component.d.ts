...
export declare class NbTreeGridComponent<T> extends NbTable<NbTreeGridPresentationNode<T>> implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbTreeGridComponent<any>, "table[nbTreeGrid]", never, { "source": "nbTreeGrid"; "equalColumnsWidth": "equalColumnsWidth"; "levelPadding": "levelPadding"; }, {}, never, never>;
}
