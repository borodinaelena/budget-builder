...
export declare class NbCalendarRangeYearCellComponent<D> extends NbBaseCalendarRangeCell<D> implements NbCalendarCell<D, NbCalendarRange<D>> {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NbCalendarRangeYearCellComponent<any>, "nb-calendar-range-year-cell", never, { "date": "date"; "min": "min"; "max": "max"; "selectedValue": "selectedValue"; "size": "size"; }, { "select": "select"; }, never, never>;
}
